...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Companie'), ['action' => 'edit', $companie->id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Companie'), ['action' => 'delete', $companie->id], ['confirm' => __('Are you sure you want to delete # {0}?', $companie->id)]) ?> </li>
...
<?php endif; ?>
    ...
    <div class="related">
                ...
                <?php 
                $this->request->session()->write('Companie.id', $companie->id);
                echo $this->Html->link(__('New Order'), ['controller' => 'Orders', 'action' => 'add'])
                ?>
